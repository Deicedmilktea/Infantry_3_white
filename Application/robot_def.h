...
/* 机器人重要参数定义,注意根据不同机器人进行修改,浮点数需要以.0或f结尾,无符号以u结尾 */
// 云台参数
#define YAW_CHASSIS_ALIGN_ECD  910   // 云台和底盘对齐指向相同方向时的电机编码器值,若对云台有机械改动需要修改
#define YAW_ECD_LESS_THAN_4096 1     // ALIGN_ECD值是否小于4096,是为1,否为0;用于计算云台偏转角度
#define YAW_CHASSIS_REVERSE    1     // 当YAW解算角度取反时
#define PITCH_HORIZON_ECD      2100  // 云台处于水平位置时编码器值,若对云台有机械改动需要修改
#define PITCH_MAX_ANGLE        28.f  // 云台竖直方向最大角度 (注意反馈如果是陀螺仪，则填写陀螺仪的角度)
#define PITCH_MIN_ANGLE        -40.f // 云台竖直方向最小角度 (注意反馈如果是陀螺仪，则填写陀螺仪的角度)
// 发射参数
...
#define STEERING_CHASSIS_ALIGN_ECD_LF   654  // 舵电机 A 编码器值，若有机械改动需要修改
#define STEERING_CHASSIS_ALIGN_ECD_LB   8166 // 舵电机 B 编码器值，若有机械改动需要修改
#define STEERING_CHASSIS_ALIGN_ECD_RF   5413 // 舵电机 C 编码器值，若有机械改动需要修改
#define STEERING_CHASSIS_ALIGN_ECD_RB   2042 // 舵电机 D 编码器值，若有机械改动需要修改
